...
function scoresToDOM() {
  ...
  baseTimeEl.textContent = `Temps de Base: ${baseTime}s`;
  penaltyTimeEl.textContent = `Pénalité: +${penaltyTime}s`;
...
function createEquations() {
  ...
  // Loop through, multiply random numbers up to 5, push to array
  for (let i = 0; i < correctEquations; i++) {
    firstNumber = getRandomInt(5);
    secondNumber = getRandomInt(5);
